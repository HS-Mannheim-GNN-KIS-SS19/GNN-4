...
public class MainFrame extends JFrame {
	...
	void displayFilters(int xOffset)
	{
	 ...
	 for (int i=0;i<NEURONS;i++){
	 	 col = (convWeight[i][0]+0.5)*255%255<0?0:(convWeight[i][0]+0.5)*255%255; inputOutput.fillRect(offset   ,10+i*40 ,9,9 ,new Color((int)col,(int)col,(int)col));
	 	 col = (convWeight[i][1]+0.5)*255%255<0?0:(convWeight[i][1]+0.5)*255%255; inputOutput.fillRect(offset+10,10+i*40 ,9,9 ,new Color((int)col,(int)col,(int)col));
	 	 col = (convWeight[i][2]+0.5)*255%255<0?0:(convWeight[i][2]+0.5)*255%255; inputOutput.fillRect(offset+20,10+i*40 ,9,9 ,new Color((int)col,(int)col,(int)col));

	 	 col = (convWeight[i][3]+0.5)*255%255<0?0:(convWeight[i][3]+0.5)*255%255; inputOutput.fillRect(offset   ,20+i*40 ,9,9 ,new Color((int)col,(int)col,(int)col));
	 	 col = (convWeight[i][4]+0.5)*255%255<0?0:(convWeight[i][4]+0.5)*255%255; inputOutput.fillRect(offset+10,20+i*40 ,9,9 ,new Color((int)col,(int)col,(int)col));
	 	 col = (convWeight[i][5]+0.5)*255%255<0?0:(convWeight[i][5]+0.5)*255%255; inputOutput.fillRect(offset+20,20+i*40 ,9,9 ,new Color((int)col,(int)col,(int)col));

	 	 col = (convWeight[i][6]+0.5)*255%255<0?0:(convWeight[i][6]+0.5)*255%255; inputOutput.fillRect(offset   ,30+i*40 ,9,9 ,new Color((int)col,(int)col,(int)col));
	 	 col = (convWeight[i][7]+0.5)*255%255<0?0:(convWeight[i][7]+0.5)*255%255; inputOutput.fillRect(offset+10,30+i*40 ,9,9 ,new Color((int)col,(int)col,(int)col));
	 	 col = (convWeight[i][8]+0.5)*255%255<0?0:(convWeight[i][8]+0.5)*255%255; inputOutput.fillRect(offset+20,30+i*40 ,9,9 ,new Color((int)col,(int)col,(int)col));
	 }
	}

	public void myMain()
	{
		FileIO inFile= new FileIO("lena.ppm");
		readImage(inFile);
